    ...
    <div style={{ padding: 20 }}>
      ...
      <Space direction="vertical" style={{ width: "100%" }}>
        ...
        <Tabs defaultActiveKey="1" onChange={handleTabChange}>
          <TabPane tab="Đối soát theo khoảng thời gian" key="1">
            ...
            {doanhThuStats && (
              <>
                  ...
                  <Col span={6}>
                    <Card>
                      <Statistic
                        ...
                        value={doanhThuStats.total.totalBookings}
                  ...
                  <Col span={6}>
                    <Card>
                      <Statistic
                        ...
                        value={
                          formatCurrency(
                            doanhThuStats.total.totalRevenue
                          ).split("₫")[0]
                        }
                        suffix="VND"
                  ...
                  <Col span={6}>
                    <Card>
                      <Statistic
                        ...
                        value={
                          formatCurrency(
                            doanhThuStats.total.totalCommission
                          ).split("₫")[0]
                        }
                        suffix="VND"
                        prefix={<DollarOutlined />}
                  ...
                  <Col span={6}>
                    <Card>
                      <Statistic
                        title="Đã thanh toán"
                        value={
                          formatCurrency(doanhThuStats.total.totalPaid).split(
                            "₫"
                          )[0]
                        }
                        suffix="VND"
                ...
                <Table
                  columns={Column}
                  dataSource={doanhThuStats.hotels}
                  loading={loading}
                  rowKey="id"
                />
              </>
